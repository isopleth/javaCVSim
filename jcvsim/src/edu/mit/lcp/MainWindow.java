...
public class MainWindow {
    ...
    public java.util.List<PlotWindow> plotWindows = new ArrayList<>();
    ...
    public MainWindow () {
	frame = new JFrame(new JcvsimVersion().toString() +
                new ExtraVersion().toString() +
                ", based on CVSim Version " + CVSim.versionNumber.toString() +
